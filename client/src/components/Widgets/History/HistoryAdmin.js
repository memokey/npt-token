...
const HistoryAdmin = memo(() => {
  ...
  useEffect(() => {
    ...
    let headers = ['Submit date&time', 'User', 'Payment method', 'Payment ID', 'Amount', 'Fee', 'Status', 'Action'];
    let items = {
      'items': [
        ['23/12/2021 13:45', 'ezio', 'paypal', 'tok_1K9pEDAjR6DfcchLvTj80a0U', '50', '1', 'pending'],
        ['23/12/2021 13:45', 'ezio', 'ALFA BANK', 'tok_1K9pEDAjR6DfcchLvTj8332U', '50', '1', 'pending'],
      ],
      'actions': ['View']
    };
    ...
    headers = ['Submit date&time', 'User', 'Withdraw address', 'Requested withdraw amount', 'Withdraw fee', 'Total deducted amount', 'Status', 'Action'];
    items = {
      'items': [
        ['23/12/2021 13:45', 'Ezio', '0x6540878656776', '1.04050', '0.003', '1.04350', 'pending'],
        ['23/12/2021 13:46', 'Ezio', '0x6540878656778', '1.04050', '0.003', '1.04350', 'pending'],
      ],
      'actions': ['View']
    };
    setWTDNPTHeadersData(headers);
    setWTDNPTItemsData(items);
    headers = ['Submit date&time', 'User', 'Requested withdraw amount', 'Withdraw fee', 'Total deducted amount', 'Status', 'Action'];
    items = {
      'items': [
        ['23/12/2021 13:45', 'Ezio', '1.04050', '0.003', '1.04350', 'pending'],
        ['23/12/2021 13:46', 'Ezio', '1.04050', '0.003', '1.04350', 'pending'],
      ],
      'actions': ['View']
    };
